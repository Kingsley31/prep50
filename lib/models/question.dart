...
class Question {
  ...
  Question.fromJson(Map<String,dynamic> json):
      id = json["id"],
        ...
        shortAnswer = json.containsKey("short_answer")?json["short_answer"]:"",
        fullAnswer= json.containsKey("full_answer")?json["full_answer"]:"",
        answerImage= json.containsKey("answer_image")?json["answer_image"]:"",
        answerDetails= json.containsKey("answer_details")?json["answer_details"]:"",
